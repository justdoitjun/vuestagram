<template>
    <div>
        <!-- 
            <props 사용방법>
                (1) 우선 exports에 props 적어주고
            props 상위 컴포넌트에서 온 데이터들을 내려줄 땐
            :작명="props변수" 이렇게 써주면 된다. 
        -->
        <!-- <VuePost :게시물="게시물[0]"/>
        <VuePost :게시물="게시물[1]"/> -->
        ...
        <!-- (1) 컴포넌트에 직접 아래같이 v-if v-for 적는 것은 금지됨. -->
...
export default {
    ...
    //상위 컴포넌트에서 하위 컴포넌트(1단계 아래)로 오려면
    props : {
